...
{
    public class ColumnUnique : IConstraintValidator
    {
        ...
        public bool ValidatePotentialCellValues(PseudoCell cell, PseudoBoard board, out string solveMessage)
        {
            ...
            {
                solveMessage = $"{solveMessage}\nRemoved {eCell.CurrentValue} from R{cell.CellRow} C{cell.CellColumn} for conflict with R{eCell.CellRow} C{eCell.CellColumn} : Column Constraint";
            ...
            if (cell.PossibleValues.Count == 1)
            {
                ...
                solveMessage = $"{solveMessage}\nSolved for {cell.CurrentValue} in R{cell.CellRow} C{cell.CellColumn} : Naked Single Column Constraint";
